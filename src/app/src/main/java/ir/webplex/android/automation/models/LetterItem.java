...
public class LetterItem implements Parcelable {
    public static final Parcelable.Creator CREATOR = new Parcelable.Creator() {
        public LetterItem createFromParcel(Parcel in) {
            return new LetterItem(in);
        }

        public LetterItem[] newArray(int size) {
            return new LetterItem[size];
        }
    };
    ...
    public LetterItem(UUID letterGuid, String subject, String indicatorDate, String indicatorNumber, int receiversCount) {
